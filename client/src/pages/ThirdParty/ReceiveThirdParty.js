...
import Qrimage from "../../assets/qrtest.png";
...
export default function ReceiveThirdParty(props) {
  ...
  const navItem = [
    ["Pembelian Produk", "/ThirdParty/allProducts"],
    ["Terima Produk", "/ThirdParty/receive"],
    ["Kirim Produk", "/ThirdParty/ship"],
  ];
  React.useEffect(() => {
    (async () => {
      setLoading(true);
      ...
      <Navbar pageTitle={"Distributor"} navItems={navItem}>
        {loading ? (
          ...
          <>
            ...
            <h1 className={classes.pageHeading}>Penerimaan Produk</h1>
